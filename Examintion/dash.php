...
$result = mysqli_query($con,"SELECT * FROM mst_subject") or die('Error');
echo '<div class="panel">
  <tr><th><a class="btn btn-primary" type="submit" href="subadd.php">Add Subject</a></th></tr>';

echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>Course ID</b></td><td><b>Course Name</b></td><td><b>Update</b></td><td><b>Delete</b></td></tr>';
...
while($row = mysqli_fetch_array($result)) {
  ...
  echo '<tr><td>'.$sub_id.'</td><td>'.$sub_name.'</td><td><a title="Edit Course" href="subupdate.php?sub_id=$sub_id"><b><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></b></a></td>      <td><a title="Delete Course" href="update.php?sub_id='.$sub_id.'"><b><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b></a></td></tr>';
}
$c=0;
echo '</table></div></div>';
